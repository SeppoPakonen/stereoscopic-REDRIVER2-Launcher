...
"stereoMode=%d				# 0=Disabled, 1=Anaglyph Simple, 2=Anaglyph Full-Color, 3=Side-by-Side, 4=Top-Bottom, 5=Interlaced, 6=Polarized, 7=Checkerboard\r\n"
"stereoSwapEyes=%d			# swap left/right eye rendering\r\n"
"stereoConvergence=%lf		# convergence distance (0.5-100.0)\r\n"
"stereoSeparation=%lf		# eye separation (0.1-3.0)\r\n"
"\r\n"
"[game]\r\n"
...
bool SaveNewConfigFile(config_data_t* data)
{
	...
	String configIniData = Format(config_ini_settings,
		...
		data->stereoMode,
		data->stereoSwapEyes,
		data->stereoConvergence,
		data->stereoSeparation,
		data->languageId,
		data->fieldOfView,
